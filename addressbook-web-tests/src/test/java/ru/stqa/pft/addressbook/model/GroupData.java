...
public class GroupData {
    ...
    @ManyToMany(mappedBy = "groups") // поиск в парном классе атрибута groups и прочтение из него правил связи
    private Set<ContactData> contacts = new HashSet<ContactData>(); //инициализация создания пустого множества
