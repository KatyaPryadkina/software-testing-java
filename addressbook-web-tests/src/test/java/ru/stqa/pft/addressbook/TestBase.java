...
public class TestBase {
  ...
  private boolean isAlertPresent() { //private - к методу можно обратиться ч/з другой метод в одном классе
    try {
      wd.switchTo().alert();
      return true;
  ...
  protected void deleteSelectedGroups() {  //protected - обращение к методу из того же самого класса и из классов наследников
